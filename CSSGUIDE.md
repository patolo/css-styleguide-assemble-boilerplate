...
### Use one base CSS/LESS/SCSS file, a file for an individual app, and a file for any unique styles on a page
...
* Write multi-line CSS/LESS/SCSS
...
For example, you may use `.error { color: #ff0000!important}` as you know you will **always** want this selector to be styled with red text.
...
Sometimes the styling of **this guide interfere** with the actual site style you created.

Check the assets/css/common folder, often it's **component-styleguide.css** involved.
* * *